...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Z-Game", NULL, NULL);
	if (window == NULL) {
	...
	if (!gladLoadGLLoader((GLADloadproc)glfwGetProcAddress)) {
		std::cout << "Failed to in itialize GLAD" << std::endl;
	}
	...
	if (data) {
		...
		std::cout << "Current workign directory: " << get_cwd() << std::endl;
	}
